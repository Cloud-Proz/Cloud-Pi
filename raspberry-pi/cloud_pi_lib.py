...
def draw_bounding_box(image, response, img_width, img_height):
    ...
    # Put the label
        ...
        cv2.putText(image, "FaceDetected: ", (img_width - 200, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36,255,12), 2)
        cv2.putText(image, label, (img_width - 200, 50 * i), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36,255,12), 2)
        i += 1
